    ...
    >
      {({ setFieldValue }) => (
        <Form className="w-full p-10 space-y-4">
          ...
          <div
            className="relative border-dashed border-2 bg-[#fdfdfd] w-full h-[360px] rounded-lg p-4 mx-auto "
          ...
          >
            ...
            />
            <div className="bg-gray-200 absolute left-[470px] top-36 flex items-center justify-center gap-2 px-6 py-2 rounded-md">
...
// import { Formik, Form, Field, ErrorMessage } from 'formik';
// import * as Yup from 'yup';
// import { usePostJobMutation, usePostLogoMutation } from '@/app/redux/service/job'; // Import services
// import Image from 'next/image';
// import { FaUpload } from "react-icons/fa";
// import { JobDetails, JobsResponse } from '@/types/types';
...
//   const [postLogo] = usePostLogoMutation();
//   const [selectedImage, setSelectedImage] = useState<string | null>(null);

//   const handleSubmit = async (values: JobDetails, { resetForm }: { resetForm: () => void }) => {
//     try {
//       // 1. Post the job details
//       const jobDetailsResponse = await postJob({
...
//       const jobUuid = jobDetailsResponse?.uuid; // Assume API response contains the `uuid`

//       // 2. If a logo file is uploaded, post it using `postLogo`
//       if (values.logo && jobUuid) {
//         await postLogo({ uuid: jobUuid, logo_url: values.logo });
//       }
...
//             <div className="relative border-dashed border-2 border-gray-300 rounded-lg p-6">
//               <input
//                 type="file"
//                 accept="image/jpg, image/jpeg, image/png, image/gif"
//                 onChange={(e) => {
